            ...
            class Q {
                ...
                change(e, t, r, o, l) {
                    ...
                    return n(function*() {
                        ...
                        if (g.isDynamicRoute(em)) {
                            ...
                            let ew = em === eb,
                                eE = ew ? H(em, eb, ef) : {};
                            if (e_ && (!ew || eE.result)) ew ? r = b.formatWithValidation(Object.assign({}, eP, {
                                pathname: eE.result,
                                query: B(ef, eE.params)
                            })) : Object.assign(ef, e_);
                            else {
                                let ex = Object.keys(eS.groups).filter(e => !ef[e] && !eS.groups[e].optional);
                                if (ex.length > 0 && !ev) throw Error((ew ? "The provided `href` (".concat(t, ") value is missing query values (").concat(ex.join(", "), ") to be interpolated properly. ") : "The provided `as` value (".concat(eb, ") is incompatible with the `href` value (").concat(em, "). ")) + "Read more: https://nextjs.org/docs/messages/".concat(ew ? "href-interpolation-failed" : "incompatible-href-as"))
                            }
                        }
                            ...
                            if ("route" in eC && ev) {
                                ...
                                if (e_ && ed !== ej && Object.keys(e_).forEach(e => {
                                    ...
                                    O.hasBasePath(eR) && (eR = C.removeBasePath(eR)); {
                                        ...
                                        V.locale = eM.detectedLocale || V.locale, eR = eM.pathname
                                    }
                    ...
                    return n(function*() {
                        ...
                        try {
                            ...
                            if ((null == M ? void 0 : null == (S = M.effect) ? void 0 : S.type) === "rewrite") {
                                ...
                                if ((!g || A.includes(L)) && (e = L, r = M.effect.resolvedHref, o = a({}, o, M.effect.parsedAs.query), i = C.removeBasePath(p.normalizeLocalePath(M.effect.parsedAs.pathname, v.locales).pathname), x = v.components[e], u.shallow && x && v.route === e && !f)) return a({}, x, {
                                    route: e
                                })
                            }
                ...
                prefetch(e) {
                    ...
                    return n(function*() {
                        ...
                        n.pathname = q(n.pathname, f), g.isDynamicRoute(n.pathname) && (l = n.pathname, n.pathname = l, Object.assign(i, _.getRouteMatcher(P.getRouteRegex(n.pathname))(w.parsePath(t).pathname) || {}), v || (e = b.formatWithValidation(n)));
                        let S = yield Z({
                            fetchData: () => Y({
                        ...
                        if ((null == S ? void 0 : S.effect.type) === "rewrite" && (n.pathname = S.effect.resolvedHref, l = S.effect.resolvedHref, i = a({}, i, S.effect.parsedAs.query), h = S.effect.parsedAs.pathname, e = b.formatWithValidation(n)), (null == S ? void 0 : S.effect.type) === "redirect-external") return;
